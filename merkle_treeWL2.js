...
const rootHashWL2 = merkleTree.getRoot();
//console.log("Whitelist Merkle Tree\n", merkleTree.toString());
//console.log("Root Hash: ", rootHashWL2);
...
// `getHexProofWL2` returns the neighbour leaf and all parent nodes hashes that will
...
//console.log(merkleTree.verify(hexProof, claimingAddress, rootHashWL2));

function getHexProofWL2(addressTest) {
	let _claimAddress = keccak256(addressTest);
	let _hexProof = merkleTree.getHexProof(_claimAddress);
	return _hexProof;
}
module.exports = { rootHashWL2, getHexProofWL2 };
